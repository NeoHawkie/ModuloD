...
<div class="flex justify-between items-center mb-4">
    ...
    <a href="index.php?action=add_game" class="bg-green-500 text-white px-4 py-2 rounded">Adicionar Jogo</a>
</div>
...
<?php foreach($games as $game): ?>
    <div class="bg-white p-4 shadow rounded">
        ...
        <a href="index.php?action=delete_game&id=<?php echo $game['id']; ?>" class="block text-red-600 mt-2">Excluir</a>
    </div>
<?php endforeach; ?>
</div>
